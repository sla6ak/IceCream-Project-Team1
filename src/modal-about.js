(() => {
    ...
    refss.openModalBtn3.addEventListener('click', toggleModal3);
    refss.closeModalBtn3.addEventListener('click', toggleModal3);
  
    function toggleModal3() {
      refss.modal3.classList.toggle('is-hidden');
      refss.modald3.classList.toggle('scroll');
    }
  })();